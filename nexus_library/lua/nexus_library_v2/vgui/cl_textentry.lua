...
function PANEL:Init()
	...
	self.TextEntry:DockMargin(Nexus:GetMargin(), 2, 0, 2)
...
function PANEL:Paint(w, h)
	Nexus.RDNX.DrawOutlined(Nexus:GetMargin(), 0, 0, w, h, Nexus:GetColor("secondary-2"), 2)
	...
	self.HoverColor = color_zero:Lerp(Nexus:GetColor("highlight"), self.HoverFrac)
