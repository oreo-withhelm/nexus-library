...
function PANEL:Init()
    ...
    self.Header.TitleBox.Logo.Paint = function(s, w, h)
        ...
        Nexus.RDNX.Draw(Nexus:GetMargin(), 0, 0, w, h, s.CurrentColor)
    ...
    self.Header.QuickButtons.AddButton = function(s, icon, doClick)
        ...
        button.Paint = function(s, w, h)
            Nexus.RDNX.Draw(Nexus:GetMargin(), 0, 0, w, h, Nexus:GetColor("highlight"))
    ...
    local textColor = Nexus:GetTextColor(Nexus:GetColor("primary-text"))
    local frac = 0
    self.CloseButton = self.Header:Add("DButton")
    self.CloseButton:Dock(RIGHT)
    self.CloseButton:SetText("")
    self.CloseButton.Paint = function(s, w, h)
        Nexus.RDNX.Draw(Nexus:GetMargin(), 0, 0, w, h, buttonColor)
...
function PANEL:Paint(w, h)
    Nexus.RDNX.Draw(self.Roundness, 0, 0, w, h, Nexus:GetColor("background"))
end
