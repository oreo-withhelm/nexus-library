...
function PANEL:Init()
    ...
    self.GripButton.Paint = function(s, w, h)
        draw.RoundedBoxEx(Nexus:GetMargin("normal"), 0, 0, w, h, Nexus:GetColor("primary-text"), false, false, true, true)
    end
end
...
function PANEL:Paint( w, h )
	draw.RoundedBoxEx(Nexus:GetMargin("normal"), 0, 0, w, h, Nexus:GetColor("header"), false, false, true, true)
end
