...
function PANEL:SelectContent(data)
    ...
    self.content.topBar:DockMargin(0, self.margin, self.margin, self.margin)
    ...
    self.content.topBar.Search:SetWide(Nexus:GetScale(150))
...
function PANEL:LoadPage(data)
    ...
    for _, v in ipairs(data.Elements or {}) do
        ...
        if v.label and not v.data.isToggle then
