...
function PANEL:Init()
    ...
    self.Header.Paint = function(s, w, h)
        ...
        draw.SimpleText(self.Title, Nexus:GetFont(26, nil, true), self.icon and Nexus:Scale(30) + height or Nexus:Scale(20), h/2 + 1, Nexus:GetColor("primary-text"), 0, 1)
    end
    ...
    self.Line:SetBackgroundColor(Nexus:GetColor("primary-text"))
end
...
function PANEL:Paint(w, h)
    self.col = self.col or table.Copy(Nexus:GetColor("secondary"))
    self.col.a = 30
    if self.stopGradient then
        draw.RoundedBox(self.margin, 0, 0, w, h, Nexus:GetColor("background"))
    else
        Nexus:DrawRoundedGradient(0, 0, w, h, Nexus:GetColor("background"), self.col, self.NoRound and 0 or self.round)
    end
    //draw.RoundedBox(self.margin, 0, 0, w, h, Nexus:GetColor("background"))
    //Nexus:Blur(self, 16, 16, 255, w, h)
end
