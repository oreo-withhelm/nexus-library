...
function PANEL:AddItem(str, func, icon)
    ...
    button.Paint = function(s, w, h)
        ...
        draw.SimpleText(str, Nexus:GetFont(25), icon and self.margin + size + self.margin or w/2, h/2, s:IsHovered() and Nexus:GetColor("primary-text") or ((self.Selected == str) and Nexus:GetColor("primary-text") or Nexus:OffsetColor(Nexus:GetColor("primary-text"), -100)), icon and 0 or 1, 1)
    end
...
function PANEL:Paint(w, h)
    self.col = self.col or Nexus:GetColor("header")
    ...
    draw.RoundedBox(self.margin, x, y, wide, self.margin, Nexus:GetColor("primary"))
end
